# referenced on https://pastebin.com/embed_js/jB6k06hG tutorial
...
def main():
    global width, rows, snk, snack
    width = 500
    rows = 20
    window = pygame.display.set_mode((width, width))
    snk = snake((255,0,0), (10,10))
    snack = cube(randomSnack(rows, snk), color=(0,255,0))
